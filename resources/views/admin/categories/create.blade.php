...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-slate-800 dark:text-white uppercase tracking-tighter">Nova Categoria</h2>
                <p class="text-sm text-slate-500">Cadastre uma nova editoria para o portal</p>
            </div>
        ...
        {{-- Container do Formulário (Padrão Edit) --}}
        <div
            ...
            <div class="p-5 border-b border-slate-100 dark:border-slate-800 bg-slate-50/30 dark:bg-transparent">
                <h2 class="font-bold dark:text-white text-sm uppercase tracking-wider text-portal-blue">
                    Formulário de Cadastro</h2>
            </div>

            <div class="p-8">
                <form action="{{ route('admin.categories.store') }}" method="POST" class="w-full space-y-8">
                    @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="w-full">
                            <label
                                class="text-[10px] font-black text-slate-500 dark:text-slate-400 mb-2 block uppercase tracking-widest">Nome
                                da Categoria</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="w-full">
                                <label
                                    class="text-[10px] font-black text-slate-500 dark:text-slate-400 mb-2 block uppercase tracking-widest">Ordem
                                    de Exibição</label>
                            ...
                            <div class="w-full">
                                <label
                                    class="text-[10px] font-black text-slate-500 dark:text-slate-400 mb-2 block uppercase tracking-widest">Cor
                    ...
                    <div
                        ...
                        <button type="submit"
                            class="w-full md:w-auto px-12 py-4 bg-portal-blue text-white rounded-lg font-black uppercase tracking-widest text-xs hover:opacity-90 transition-all shadow-xl shadow-portal-blue/20 active:scale-95">
                            Criar Categoria
                        </button>
